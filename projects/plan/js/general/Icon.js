...
class Icon {
    ...
    cogwheel_icon(settings) {
        settings = this.#checkAvailibleProps(settings);
        return this.#cogWheelIcon(settings);
    }

    #checkAvailibleProps(settings) {
        let newSettings = {};
        if (settings != null) {
            newSettings.width = (settings.width != null) ? settings.width : 17;
            newSettings.height = (settings.height != null) ? settings.height : 17;
    ...
    #createIconStyling(style) {
        ...
        if (styleTag != null) {
            ...
            const stylingTags = this.#createElm({ name: "style" });
            stylingTags.textContent += style;
    ...
    #cogWheelIcon(settings) {
        ...
        const cogwheelElm = this.#createElm({ class: classes.cogwheel_icon_class });
        const cogwheelCenter = this.#createElm({ class: classes.cogwheel_center_icon_class });
    ...
    #saveLoadIcon(settings) {
        ...
        //create elements 
        const div1 = this.#createElm({ class: classes.load_save_icon_class });
        const div2 = this.#createElm();
        const div3 = this.#createElm();
        const div4 = this.#createElm();
        const div5 = this.#createElm({ class: classes.load_save_arrow });
        const div6 = this.#createElm();
